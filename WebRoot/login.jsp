...
<head>
    ...
    {
	   margin-left: 0px;
	    background-image: url(<%=path %>/img/1.jpg);
    }
    .style2 {color: #990001}
    .input2 
    {
...
<body>
	<font color="#80ff80"><br><br><br><br></font>
	
	
	
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  >
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 40pt;"><font color="#80ff80">项目管理系统</font></div></td>
	 </tr>
	 <tr>
		<td width="559">
